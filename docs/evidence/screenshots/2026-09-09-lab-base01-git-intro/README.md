...
[結果票へ戻る](../../practice/2026-09-09-lab-base01-git-intro-practice.md)
...
![Git未管理と演習フォルダーの一覧](E01-before.png)

## E02 9ファイルのステージ・127行・空白検査出力なし

![9ファイルのステージ・127行・空白検査出力なし](E02-staged.png)

## E03 Author identity unknownにより初回コミット停止

![Author identity unknownにより初回コミット停止](E03-identity-error.png)

## E04 root commit a94c1d3・9ファイル・main clean

![root commit a94c1d3・9ファイル・main clean](E04-committed.png)

...
```mermaid
flowchart LR
    R["要件ID<br/>00"] --> D["基本・詳細設計<br/>01-04"]
    D --> P1B["フェーズ1<br/>ホスト単体構築<br/>05 手動PowerShell"]
    P1B --> P1T["フェーズ1試験<br/>06 WUT/WIT/WST/WNW"]
    P1T --> P2B["フェーズ2<br/>中央監視統合<br/>未実装3点の解消後"]
    P2B --> P2T["フェーズ2試験<br/>06 WIT-03,05,06,07,11"]
    P1T --> E["日付付き実測証跡<br/>docs/evidence"]
    P2T --> E
    E --> W["作業結果報告<br/>11"]
    W --> H["引き渡し判定<br/>07"]
```

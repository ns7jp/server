...
2026-09-06の [AIによる初回実施記録](practice/first-run-2026-09-06.md) と [実践手順](practice/README.md) を追加した。既存PRの状態と保存済みCI結果を確認し、資料提供を区切った記録である。初回の入力・出力・観測情報を保持し、本人の行動改善や実サーバー試験の証拠へ読み替えない。
